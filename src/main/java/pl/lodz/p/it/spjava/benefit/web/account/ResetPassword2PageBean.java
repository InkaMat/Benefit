...
public class ResetPassword2PageBean implements Serializable {
    ...
    public void setMyAnswer(String myAnswer) {
        ...
        @PostConstruct
    public void init() {
        accountDTO = accountControllerBean.getAccountDtoQuestionCheck();
    }
     ...
     public String resetPassword2Action() throws AppBaseException {
        ...
        try {
            ...
            if (accountDTO == null || accountDTO.getLogin() != accountControllerBean.getAccountDtoPasswordReset().getLogin()) {
